...
class Documents
{
    ...
    public static function printCheck($ORDER_ID)
    {
        $doc = 'invoice';
        global $USER;
...
//                $arOrder['DELIVERY_VAT_RATE'] = $shipment->getVatRate();
            ...
            $rep_file_name = self::GetRealPath2Report(
                $doc . ".php"
            );
    ...
    public static function GetRealPath2Report($rep_name)
    {
     ...
     */
    public static function GetUniformDestribution($arBasket, $discount, $priceTotal)
    {
